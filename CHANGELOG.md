...
- 手机端阅读页支持左右点击翻页
- 手机端阅读页支持横向滑动翻页
- 手机端底栏调整为目录、界面、设置、日间/夜间切换
- 设置面板收纳搜索、书签、加书签、章节切换和返回书架
- 阅读字体新增系统、黑体、宋体、楷体、等宽选项
- 阅读主题新增暖阳、雾蓝和夜间模式
- 阅读界面新增覆盖、滑动、仿真、滚动和无动画翻页模式
- 阅读界面新增字重、字距、段距、两端对齐和底部对齐选项
- APK 新增屏幕常亮、扩展到刘海、隐藏状态栏、隐藏导航栏、音量键翻页控制

### Changed

- 默认阅读字体改为更适合手机中文阅读的系统字体栈
- 设置面板适配更多字体和主题选项，移动端高度过长时可滚动
- 手机端顶部栏简化为返回和书籍信息，减少阅读干扰
- 新增 Android 原生阅读控制插件，专门处理系统栏、屏幕常亮和音量键
