...
当前阶段：React + Vite 网页版 + Electron / Tauri 桌面端打包。
...
说明：Tauri 需要本机安装 Rust 工具链和对应系统构建依赖。当前仓库已包含 `src-tauri` 工程配置。
...
这是第五阶段版本，在 Electron 桌面端基础上加入 Tauri 工程配置和打包脚本。

详细版本记录见 [CHANGELOG.md](./CHANGELOG.md) 和 [RELEASE_NOTES_v0.5.0.md](./RELEASE_NOTES_v0.5.0.md)。
